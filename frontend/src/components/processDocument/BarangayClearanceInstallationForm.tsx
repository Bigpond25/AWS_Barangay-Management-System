// ============================================================================
// BarangayClearanceInstallationForm.tsx - Installation/Contracting Clearance Form
// ============================================================================
...
interface BarangayClearanceInstallationFormProps {
  onNavigate: (page: string) => void;
}

const BarangayClearanceInstallationForm: React.FC<BarangayClearanceInstallationFormProps> = ({ onNavigate }) => {
  ...
  const form = useForm<DocumentFormData>({
    ...
    defaultValues: {
      type: 'BARANGAY_CLEARANCE_INSTALLATION',
      resident_id: '',
      applicant_name: '',
      purpose: 'INSTALLATION_CONTRACTING',
      applicant_address: '',
      applicant_contact: '',
      applicant_email: '',
      priority: 'NORMAL',
      needed_date: '',
      processing_fee: 0, // No fee for installation clearance
      clearance_purpose: '',
      clearance_type: 'INSTALLATION',
      business_name: '',
      business_address: '',
      business_owner: '',
  ...
  const documentForm = useDocumentForm({
    documentType: 'BARANGAY_CLEARANCE_INSTALLATION',
    onSuccess: (_document) => {
      showNotification({
        type: 'success',
        title: 'Request Submitted',
        message: 'Barangay Clearance (Installation/Contracting) request has been submitted successfully'
      });
      setStep(3);
    },
    onError: (error) => {
  ...
  useEffect(() => {
    if (selectedResident) {
      ...
      setValue('type', 'BARANGAY_CLEARANCE_INSTALLATION');
  ...
  useEffect(() => {
    setValue('processing_fee', 0); // Always free
  }, [priority, setValue]);
  ...
  const renderStep2 = () => (
    <FormProvider {...form}>
      <form onSubmit={onSubmit} className={`space-y-6 transition-all duration-700 ease-out ${
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          <h2 className="text-lg font-semibold text-darktext mb-4 border-l-4 border-smblue-400 pl-4">
            Installation/Contracting Clearance Details
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <DocumentFormField
              name="business_owner"
              label="Business Owner/Contractor"
              type="text"
              placeholder="Enter owner or contractor name"
              required
            />

            {/* Clearance Purpose/Details Field - Full Width */}
            <div className="md:col-span-2">
              <DocumentFormField
                name="clearance_purpose"
                label="Project/Installation Details"
                type="text"
            ...
            <div className="md:col-span-2">
              <DocumentFormField
                ...
                label="Installation/Project Site Address"
                type="text"
                placeholder="Enter complete installation or project site address"
                required
              />
            </div>
            ...
            <div className="md:col-span-2">
              <DocumentFormField
                ...
                type="textarea"
                placeholder="Project details, duration, special requirements, or any additional information..."
                rows={3}
              />
            </div>
          </div>
  ...
  const renderStep3 = () => (
    <div className={`bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center transition-all duration-700 ease-out ${
      ...
      <p className="text-gray-600 mb-6">
        Your Barangay Clearance (Installation/Contracting) request has been submitted and is now being processed.
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className={`mb-6 transition-all duration-700 ease-out ${
        ...
        <h1 className="text-2xl font-bold text-darktext">Barangay Clearance (Installation/Contracting) Request</h1>
        <p className="text-gray-600 mt-1">Request a barangay clearance for installation or contracting purposes</p>
      </div>
...
export default BarangayClearanceInstallationForm;