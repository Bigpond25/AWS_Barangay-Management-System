// ============================================================================
// previews/CertificateOfResidencyPreview.tsx - Certificate of Residency Preview with Sample Data
// ============================================================================
...
const CertificateOfResidencyPreview: React.FC = () => {
  ...
  const sampleData = {
    applicantName: 'ANTONIO DELA ROSA',
    applicantAddress: 'Unit 3B, Sikatuna Heights, Brgy. Sikatuna Village, Samal, Bataan',
    purpose: 'school enrollment requirement',
    documentNumber: 'CR-2024-01-0001',
    processingFee: 30.00,
    certifyingOfficial: 'ELENA CRUZ RODRIGUEZ',
    residencyPeriod: 'fifteen (15) years',
          ...
          <div className="bg-white p-8 shadow-lg print:shadow-none print:p-0 certificate-body">
            ...
            <div className="mb-8">
              ...
              <p className="text-base leading-relaxed text-justify mb-6">
                ...
                {sampleData.residencyPeriod && <span> for <span className="font-semibold">{sampleData.residencyPeriod}</span></span>}.
              </p>
...
export default CertificateOfResidencyPreview;
