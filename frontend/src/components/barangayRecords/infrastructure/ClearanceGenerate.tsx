  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center mb-6">
        ...
        >
          <FiArrowLeft className="mr-2" /> Back to Infrastructure Details
        </button>
      </div>
        ...
        <div className="mb-4">
          <div style={{ width: "100%"}}>
            <input
              ...
              className="border border-black bg-[#eae8dc] focus:outline-none px-1 text-center w-full"
            />{" "}
          </div>
          <p className="my-2 text-center">is hereby granted CLEARANCE for the{" "}</p>
          <div style={{ width: "100%"}}>
            <input
              name="business"
              disabled
          ...
          <p className="text-center my-3">at{" "}</p>
          <div style={{ width: "100%"}}>
            <input
              name="address"
              value={form.address}
