...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('complaints', function (Blueprint $table) {
            ...
            // Complaint Details
            $table->enum('category', [
                'PUBLIC_SERVICES', 'INFRASTRUCTURE', 'SOCIAL_WELFARE', 'PUBLIC_SAFETY',
                'HEALTH_SERVICES', 'ENVIRONMENTAL', 'EDUCATION', 'BUSINESS_PERMITS',
                'COMMUNITY_PROGRAMS', 'OTHERS'
            ]);
            ...
            // Status specific to complaints
            $table->enum('status', ['RECEIVED', 'INVESTIGATING', 'RESOLVED', 'CLOSED', 'REJECTED'])->default('RECEIVED');
